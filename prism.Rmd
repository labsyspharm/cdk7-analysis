...
* Check lineage enrichment for highly responsive cell lines. Differences between compounds?
...
```{r}
plot_auc_expression_corr <- function(gene, rank_transform = FALSE) {
...
pwalk(
  ...
  \(term, p, ...) {
    ggsave(
      file.path(plot_dir, "enrichment", paste0(term, "_enrichment.pdf")),
      p, width = 12, height = 7
    )
  }
)
